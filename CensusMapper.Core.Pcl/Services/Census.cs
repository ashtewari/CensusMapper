...
namespace CensusMapper
{
    public class Census
    {
        ...
        public string StateAbbreviationToFips(string abbreviation)
        {
        ...
        public Dictionary<string, UsState> GetStatesList()
        {
        ...
        public string StateAbbreviationToName(string abbreviation)
        {
